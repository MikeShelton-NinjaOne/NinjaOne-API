...
| **Scopes** | Check **Monitoring** and **Management** | Management is required to create tickets. Monitoring is required to read account information. |
...
3. Verify the API client app in NinjaOne has **Authorization Code** AND **Refresh Token** checked under Allowed Grant Types, and **Monitoring** + **Management** checked under Scopes.
